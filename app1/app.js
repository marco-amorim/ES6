...
class Bd {
    ...
    recuperarTodosRegistros() {
        ...
        for (let i = 1; i <= id; i++) {
            ...
            //existe a possiblidade de haver indices que foram pulados/removidos
    ...
    listaDespesas.innerHTML = ''
        ...
        despesas.forEach(d => {
            ...
            btn.onclick = function() {
                ...
                //formatar a string 'id_despesa_'
                let id = this.id.replace('id_despesa_', '')

                let confirmar = confirm('Deseja realmente deletar a despesa?')
                ...
                //atualiza a pagina para retirar conteudo HTML
